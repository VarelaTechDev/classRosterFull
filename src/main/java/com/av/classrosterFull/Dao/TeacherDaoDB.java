...
public class TeacherDaoDB implements TeacherDao{
    ...
    @Override
    @Transactional // Informing Spring you're going to do something important and makes sure everything is "done"
    ...
    // Of course, we imported the wrong RowMapper (springframework.jdbc)
